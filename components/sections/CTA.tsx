        ...
        <Reveal>
          <div className="relative overflow-hidden rounded-[2.5rem] bg-ink px-6 py-20 text-center sm:px-12">
            ...
            <div className="relative mx-auto max-w-3xl">
              <p className="label-caps text-accent">Join the cluster</p>
              <h2 className="mt-5 font-display text-4xl font-extrabold leading-tight tracking-tight text-white sm:text-5xl">
                ...
                <br />
                <span className="accent-italic text-accent">hydrogen revolution</span>
              </h2>
              <p className="mx-auto mt-6 max-w-xl text-lg text-white/70">
                Industry, research and government — working as one cluster. Explore collaboration,
                tenders and career opportunities with the Foundation.
              </p>
              <div className="mt-10 flex flex-wrap justify-center gap-4">
                ...
                >
                  Get in touch <IconArrowRight className="h-5 w-5" />
                </Link>
                <Link
                  href="/tenders"
